...
export function TemplateCard({
  ...
  return (
    ...
    <article className="group/card @container relative flex flex-col overflow-hidden rounded-2xl border bg-card shadow-sm ring-1 ring-transparent transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-xl hover:shadow-black/5 hover:ring-border dark:hover:shadow-black/20">
      {/*
        ...
        <div className="mt-auto flex flex-col gap-3 pt-6 @sm:flex-row @sm:flex-wrap @sm:items-center">
          ...
          */}
          ...
          <a
            ...
            className="group inline-flex w-full items-stretch gap-1 rounded-md outline-none transition-transform duration-200 hover:-translate-y-0.5 focus-visible:ring-3 focus-visible:ring-ring/50 @sm:w-auto"
          >
            <span className="flex-1 rounded-md border border-border bg-background px-5 py-3 text-center text-xs font-medium tracking-widest text-foreground uppercase transition-colors group-hover:bg-muted @sm:flex-none">
              Live preview
            ...
            <ArrowChip className="border border-border bg-background text-foreground transition-colors group-hover:bg-muted" />
